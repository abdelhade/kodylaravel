...
@section('content')
<div class="content-wrapper" style="background-color: #e0f2f1;">
                        ...
                        <table class="table table-bordered table-hover" style="background: white;">
                            ...
                            <tbody>
                                ...
                                <tr style="border-bottom: 1px solid #e0e0e0;">
                                    <td class="text-center font-weight-bold">{{ $invoice->pro_id }}</td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button class="btn btn-sm btn-info" onclick="printInvoice({{ $invoice->id }})" title="طباعة">
