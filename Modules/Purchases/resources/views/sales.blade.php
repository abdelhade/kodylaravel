    ...
    <section class=\"content-header\">
        <div class=\"container-fluid p-0 m-0\">
            ...
            @php
                ...
                $invoice_title = $invoice_names[$pro_type] ?? 'فاتورة';
                
                $bg_class = in_array($pro_type, [3, 4]) ? 'bg-teal-500' : 'bg-red-500';
            @endphp
            
            <input type=\"hidden\" name=\"pro_tybe\" value=\"{{ $pro_type }}\">
            
            <div class=\"text-center mb-4\">
                <h4 class=\"font-thin text-md {{ $bg_class }} text-teal-50 hadi-wonder p-3\" style=\"font-size:2em;\">
                    {{ $invoice_title }}
                </h4>
            </div>
            ...
            <div class=\"card\">
                <div class=\"card-body p-0 m-0\">
                    ...
                    <form action=\"#\" method=\"post\" id=\"invoiceForm\">
                        ...
                        <div class=\"row mb-3\">
                            <div class=\"col-md-3\">
                                <label>{{ in_array($pro_type, [3, 4]) ? 'المورد' : 'العميل' }}</label>
                                <select name=\"client_id\" class=\"form-control\" required>
                                    <option value=\"\">{{ in_array($pro_type, [3, 4]) ? 'اختر المورد' : 'اختر العميل' }}</option>
                                </select>
                            </div>
                            <div class=\"col-md-3\">
                                <label>التاريخ</label>
