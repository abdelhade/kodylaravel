                ...
                <form role="form" action="{{ route('manual-attendance.store') }}" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="date" name="fpdate" id="fpdate" value="{{ old('fpdate', date('Y-m-d')) }}">
                        </div>

                        <div class="form-group">
                            <label for="fptime">{{ $lang['lang_adfp_time'] ?? 'الوقت' }}</label>
                            <input class="form-control" type="time" name="fptime" id="fptime" value="{{ old('fptime', date('H:i')) }}">
                        </div>
                    </div>
