                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select required class="form-control" name="employee" id="employee">
                                            <option value="0" {{ old('employee', $employeeId) == 0 ? 'selected' : '' }}>كل الموظفين</option>
                                            @foreach($employees as $employee)
                                                <option value="{{ $employee->id }}" {{ old('employee', $employeeId) == $employee->id ? 'selected' : '' }}>
                                                    {{ $employee->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input required name="fromdate" class="form-control" type="date" value="{{ old('fromdate', $fromDate ?? date('Y-m-d')) }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="todate">إلى:</label>
                                        <input required name="todate" class="form-control" type="date" value="{{ old('todate', $toDate ?? date('Y-m-d')) }}">
                                    </div>
                                </div>
                                <div class="col-md-2">
