            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" id="search" class="form-control frst" placeholder="بحث...">
                        </div>
                        <div class="col">
                            <div class="d-flex gap-2 justify-content-end">
                                <a href="{{ route('items.create') }}" id="addNewElement" class="btn btn-primary btn-sm">F3 جديد</a>
                                <a href="{{ route('items.recost') }}" class="btn btn-secondary btn-sm">اعادة حساب</a>
                            ...
                            <tbody>
                                @foreach($items as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-warning btn-sm" href="{{ route('items.edit', ['edit' => $item->id]) }}">
                                                <i class="fa fa-pen"></i>
                                            </a>
