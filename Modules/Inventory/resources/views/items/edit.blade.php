                ...
                <div class="card">
                    <form id="myForm" action="{{ route('items.update') }}?edit={{ $item->id }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input readonly value="{{ $item->code }}" class="form-control form-control-sm col-4" type="text" name="code" id="code">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="barcode">الباركود</label>
                                        <input value="{{ $item->barcode }}" class="form-control form-control-sm" type="text" name="barcode" id="barcode">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input list="inamelist" required class="frst form-control form-control-sm" type="text" name="iname" id="iname" value="{{ old('iname', $item->iname) }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="name2">اسم ثاني</label>
                                        <input class="form-control form-control-sm" type="text" name="name2" id="name2" value="{{ old('name2', $item->name2) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-sm" type="text" name="info" id="info" value="{{ old('info', $item->info) }}">
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tbody>
                                                @foreach($itemUnits as $itemUnit)
                                                    <tr class="urow">
                                                        <td>
                                                            <select name="unit_id[]" class="form-control">
                                                                @foreach($units as $unit)
                                                                    <option value="{{ $unit->id }}" {{ $unit->id == $itemUnit->unit_id ? 'selected' : '' }}>
                                                                        {{ $unit->uname }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <td>
                                                            <input class="form-control" type="number" name="u_val[]" value="{{ $itemUnit->u_val }}" step="0.001">
                                                        </td>
                                                        <td>
                                                            <input class="form-control" type="text" name="unit_barcode[]" value="{{ $itemUnit->unit_barcode }}">
                                                        </td>
                                                        <td>
                                                            <input type="number" name="cost_price[]" class="form-control form-control-sm" value="{{ $itemUnit->cost_price }}" step="0.001">
                                                        </td>
                                                        <td>
                                                            <input type="number" name="price1[]" class="form-control form-control-sm" value="{{ $itemUnit->price1 }}" step="0.001">
                                                        </td>
                                                        <td>
                                                            <input type="number" name="price2[]" class="form-control form-control-sm" value="{{ $itemUnit->price2 }}" step="0.001">
                                                        </td>
                                                        <td>
                                                            <input type="number" name="market_price[]" class="form-control form-control-sm" value="{{ $itemUnit->price3 }}" step="0.001">
                                                        </td>
                                                        <th>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="group1" id="group1" class="form-control form-control-sm float-right">
                                            ...
                                            @foreach($groups1 as $group)
                                                <option value="{{ $group->id }}" {{ old('group1', $item->group1) == $group->id ? 'selected' : '' }}>
                                                    {{ $group->gname }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="group2" id="group2" class="form-control form-control-sm float-right">
                                            ...
                                            @foreach($groups2 as $group)
                                                <option value="{{ $group->id }}" {{ old('group2', $item->group2) == $group->id ? 'selected' : '' }}>
                                                    {{ $group->gname }}
                                                </option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col">
                                    <button type="submit" class="btn btn-warning btn-lg float-right btn-block">حفظ</button>
                                </div>
                                <div class="col"></div>
                            </div>
                        </div>
