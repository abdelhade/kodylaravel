                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="voucher_id" class="form-control form-control-lg" 
                                           value="{{ $voucher->pro_id }}" required readonly
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="vdate" class="form-control form-control-lg" 
                                           value="{{ $voucher->pro_date }}" required>
                                </div>
                            </div>
                                    ...
                                    <select name="account" id="account" class="form-control select2" required>
                                        ...
                                        @foreach($accounts as $account)
                                            <option value="{{ $account->id }}"
                                                @if($voucher_type == 'payment' && $account->id == $voucher->acc1) selected
                                                @elseif($voucher_type == 'recive' && $account->id == $voucher->acc2) selected
                                                @endif>
                                    ...
                                    <select name="fund_account" id="fund_account" class="form-control select2" required>
                                        @foreach($fund_accounts as $fund)
                                            <option value="{{ $fund->id }}"
                                                @if($voucher_type == 'payment' && $fund->id == $voucher->acc2) selected
                                                @elseif($voucher_type == 'recive' && $fund->id == $voucher->acc1) selected
                                                @endif>
                        ...
                        <div class="row">
                                    ...
                                    <select name="cost_center" class="form-control">
                                        ...
                                        @foreach($cost_centers as $center)
                                            <option value="{{ $center->id }}"
                                                {{ $voucher->cost_center == $center->id ? 'selected' : '' }}>
                                                {{ $center->cname }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <textarea name="info" id="info" class="form-control" rows="2">{{ $voucher->info }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <div class="alert alert-info">
                                    ...
                                    <strong>ملاحظة:</strong> تعديل السند سيؤثر على القيود المحاسبية المرتبطة به
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-warning btn-lg btn-block">
                                    <i class="fas fa-save"></i> تحديث السند
                                </button>
                            </div>
                            <div class="col-md-4">
                                <button type="reset" class="btn btn-secondary btn-lg btn-block">
                                    <i class="fas fa-undo"></i> التراجع عن التغييرات
                                </button>
                            </div>
                            <div class="col-md-4">
