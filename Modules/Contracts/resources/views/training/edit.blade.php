            ...
            <form id="validate_form" role="form" action="{{ route('contracts.update', ['id' => $contract->id]) }}" method="POST">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">{{ $lang['lang_addhicont_newtrianing'] ?? 'تعديل عقد تدريب' }}</h3>
                    </div>
                    <div class="card-body">
                        @if($errors->any())
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="user" type="number" data-parsley-trigger="keyup" required id="user" class="form-control" value="{{ old('user', $contract->user ?? session('userid')) }}" readonly>
                                </div>
