...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ $lang['lang_sidetrainingcontracts'] ?? 'عقود التدريب' }}</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            <a href="{{ route('contracts.training.create') }}" class="btn btn-large btn-primary">
                    ...
                    <div class="card-body">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>م</th>
                                    <th>{{ $lang['lang_employeename'] ?? 'اسم الموظف' }}</th>
                                    <th>{{ $lang['lang_addemployee_job'] ?? 'الوظيفة' }}</th>
                                    <th>{{ $lang['lang_addemployee_salary'] ?? 'المرتب' }}</th>
                                    <th>{{ $lang['lang_publicdetails'] ?? 'تفاصيل' }}</th>
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center">لا توجد عقود تدريب</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
