...
<div class="supplier-form-container">
    <div class="supplier-card">
        <h2 class="card-title">
            <i class="fas fa-truck-loading mr-2"></i> مورد جديد
        </h2>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code', $nextCode) }}" readonly required>
                        @error('code')
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" name="aname" id="aname" class="form-control @error('aname') is-invalid @enderror" value="{{ old('aname') }}" placeholder="ادخل اسم المورد" required>
                        @error('aname')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
