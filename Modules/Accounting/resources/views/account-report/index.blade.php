        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="row">
                    <div class="col"></div>
                    <div class="col">
                        <input class="form-control form-control-sm frst" type="text" name="" id="itmsearch"
                            ...
                            @forelse($accounts as $index => $account)
                                <tr class="tr1">
                                    ...
                                    <td>
                                        ...
                                        <a href="/edit_account/delete?id={{ $account->id }}" class="btn btn-danger"
                                            onclick="return confirm('هل تريد حذف هذا الحساب؟')">
        ...
        $(document).ready(function() {
            ...
            $('#itmsearch').on('keyup', function() {
                ...
                $('#myTable tbody tr').each(function() {
                    ...
                    if (code.includes(searchTerm) || name.includes(searchTerm) || id.includes(
                            searchTerm)) {
                        $(this).show();
                    } else {
                        $(this).hide();
