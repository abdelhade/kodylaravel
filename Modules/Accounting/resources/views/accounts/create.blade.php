...
<div class="form-container">
    <div class="premium-card">
        <h2 class="card-title">
            <i class="fas {{ $mainIcon }} mr-2"></i> إضافة في [ {{ $pageTitle }} ]
        </h2>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="code">الكود الرقمي</label>
                        <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code', $lastId) }}" placeholder="ادخل الكود الجديد" required {{ $accType ? 'readonly' : '' }}>
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" name="aname" id="aname" class="form-control @error('aname') is-invalid @enderror" value="{{ old('aname') }}" placeholder="ادخل الاسم الكامل للجهة" required onkeyup="checkAccountName(this.value)">
                    ...
                    <div class="form-group">
                        ...
                        <select name="parent_id" id="parent_id" class="form-control @error('parent_id') is-invalid @enderror" required>
                            @foreach($parentAccounts as $pAcc)
                                <option value="{{ $pAcc->id }}" {{ $parent == $pAcc->code ? 'selected' : '' }}>{{ $pAcc->code }} - {{ $pAcc->aname }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="is_basic" id="is_basic" class="form-control">
                            <option value="0" {{ $accType ? 'selected' : '' }}>حساب فرعي (يقبل حركة)</option>
                            @if(!$accType)
                                <option value="1">حساب رئيسي (تجميعي فقط)</option>
                            @endif
                        </select>
                    </div>
                </div>
            ...
            <div class="row mt-3">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="phone" id="phone" class="form-control" value="{{ old('phone') }}" placeholder="اختيارى">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="address">العنوان</label>
                        <input type="text" name="address" id="address" class="form-control" value="{{ old('address') }}" placeholder="اختيارى">
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <label class="d-flex align-items-center gap-2">
                                <input type="checkbox" name="is_fund" value="1" class="custom-checkbox">
                                <span>صندوق مالي</span>
                            </label>
                        </div>
                        <div class="col-md-3">
                            <label class="d-flex align-items-center gap-2">
                                <input type="checkbox" name="rentable" value="1" class="custom-checkbox">
                                <span>قابل للإيجار</span>
                            </label>
                        </div>
                        <div class="col-md-3">
                            <label class="d-flex align-items-center gap-2">
                                <input type="checkbox" name="is_stock" value="1" class="custom-checkbox">
                                <span>مخزن بضاعة</span>
                            </label>
                        </div>
                        <div class="col-md-3">
                            <label class="d-flex align-items-center gap-2">
                                <input type="checkbox" name="secret" value="1" class="custom-checkbox">
                                <span>حساب سري</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <button type="submit" class="btn-submit">
                                <i class="fas fa-save mr-2"></i> حفظ كـ {{ $pageTitle }}
                            </button>
                        </div>
                        <div class="col-6">
