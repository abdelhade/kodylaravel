                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input name="journal_id" type="text" class="form-control"
                                            value="{{ old('journal_id', $nextId) }}" required>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input name="jdate" type="date" class="form-control"
                                            value="{{ old('jdate', date('Y-m-d')) }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody id="depitBody">
                                        <tr id="depitTr" class="depitTr">
                                            <td>
                                                <input class="form-control depit" type="number" name="depitval[]"
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <button type="button" class="btn bg-sky-200" id="addDepit">+ إضافة صف
                                                    مدين</button>
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody id="creditBody">
                                        <tr id="creditTr" class="creditTr">
                                            <td>
                                                <input class="form-control credit" type="number" name="creditval[]"
                                                    step="0.01" min="0" value="0" required>
                                            </td>
                                            <td>
                                                <select class="form-control creditacc" name="creditname[]"
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <button type="button" class="btn bg-sky-200" id="addCredit">+ إضافة صف
                                                    دائن</button>
                                            </td>
                                        </tr>
                                    </tbody>
        ...
        $(document).ready(function() {
            ...
            $('#addDepit').click(function(e) {
                ...
                newRow.find('td:last').html(
                    '<button type="button" class="delete-row btn btn-danger btn-sm">X</button>');
            ...
            $('#multiJournalForm').on('submit', function(e) {
                ...
                if (Math.abs(balance) > 0.01) {
                    e.preventDefault();
                    alert('المدين يجب أن يساوي الدائن! المدين: ' + depitTotal.toFixed(2) + ' | الدائن: ' +
