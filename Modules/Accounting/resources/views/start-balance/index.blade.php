                            ...
                            <tbody>
                                @foreach ($accounts as $account)
                                    <tr>
                                        <td>
                                            {{ $account->code }}
                                            <input name="acc_id[]" type="hidden" class="acc_id"
                                                value="{{ $account->id }}">
                                        </td>
                                        <td>{{ $account->aname }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" readonly class="form form-control settle m-0 p-0"
                                                value="00.00">
                                        </td>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateTotals() {
                ...
                rows.forEach(function(row) {
                    ...
                    const oldBalance = parseFloat(row.querySelector('.old-balance').textContent.replace(
                        /,/g, '')) || 0;
            ...
            balanceInputs.forEach(function(input) {
                input.addEventListener('input', function() {
                    ...
                    const oldBalance = parseFloat(row.querySelector('.old-balance').textContent
                        .replace(/,/g, '')) || 0;
