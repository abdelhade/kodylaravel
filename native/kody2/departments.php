              ...
              ?>
                <tbody>
                  <tr>
                    ...
                    <th><?= $row['info'] ?></th>
                    <th><a class="btn btn-warning" href="edit_department.php?id=<?= $row['id'] ?>"><?= $lang_edit ?></a> <a href="dodel_department?id=<?= $row['id'] ?>" class="btn btn-danger" data-toggle="modal" data-target="#modal-danger">
                        حذف
                      </a>
