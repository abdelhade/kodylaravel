...
<head>
    ...
    <title>{{ isset($settings['lang_title']) ? $settings['lang_title'] : (isset($lang['lang_title']) ? $lang['lang_title'] : 'Dashboard') }}</title>
    ...
    <link rel="stylesheet" href="{{ asset('modules/kody2/plugins/datatables-responsive/css/responsive.bootstrap4.min.css') }}">
    <link rel="stylesheet" href="{{ asset('modules/kody2/plugins/datatables-buttons/css/buttons.bootstrap4.min.css') }}">
    <!-- Theme style -->
    <!-- Ionicons -->
    <link rel="stylesheet" href="{{ asset('modules/kody2/dist/css/ionicons.min.css') }}">
    <!-- Tempusdominus Bbootstrap 4 -->
    <link rel="stylesheet" href="{{ asset('modules/kody2/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
    <!-- iCheck -->
    ...
    <link rel="stylesheet" href="{{ asset('modules/kody2/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css') }}">
...
<body class="hold-transition sidebar-mini layout-fixed font-semibold" style="font-family: 'Playpen Sans Arabic', cursive;">
    <div class="wrapper">
