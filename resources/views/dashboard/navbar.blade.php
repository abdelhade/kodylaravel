    ...
    <div class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <ul class="navbar-nav align-items-center gap-2 mb-0 me-auto">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('dashboard.index') }}" class="nav-link active fw-bold">{{ $lang['lang_sidemain'] ?? 'الرئيسية' }}</a>
            </li>
        ...
        <div class="d-flex align-items-center gap-3 ms-auto">
            ...
            <a href="{{ route('logout') }}" class="logout-link d-flex align-items-center px-2 py-1 rounded-pill" data-bs-toggle="tooltip" data-bs-placement="bottom" title="تسجيل الخروج">
                <i class="fas fa-sign-out-alt me-1"></i> <span class="d-none d-sm-inline-block">{{ $lang['lang_navlogout'] ?? 'تسجيل الخروج' }}</span>
            </a>
        </div>
    </div>
</nav>
